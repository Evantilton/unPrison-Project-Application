    ...
    render() {
        return (
            <div>
                ...
                <ul class="nobullet">
                    <li>
                        <button className="tabButtonPosition" onClick={() => { if (window.confirm('Are you sure you wish to delete this event? This cannot be undone and will delete all information pertaining to this event as well. This will not affect the venue for this event.')) this.handleDeleteButtonClick(this.props.eventId) }}>Delete Event</button>
