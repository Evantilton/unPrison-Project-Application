        ...
        <>
            ...
            <div className="mainWindow">
                <div className="mainInfo">
                    <h3>When?<button className="tabButtonPosition" onClick={this.handleDeleteClick}>Delete Event</button><button className="tabButtonPosition" onClick={this.handleSaveChangesButtonClick}>Save Changes</button></h3>
                </div>
